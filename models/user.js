...
class User {
   ...
   *
   * Returns { username, first_name, last_name, email, skill }
   *
  ...
  static async register(
    { username, password, firstName, lastName, email, skill }) {
   ...
   *
   * Returns { username, first_name, last_name, skill, connections }   *   
   *
